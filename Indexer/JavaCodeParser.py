...
if __name__ == '__main__':
	...
	#source = 'StringBuilder sb = new StringBuilder(); sb.append("a"); sb.append("b"); String l = sb.toString();'
...
Collections.shuffle(imgList, new Random(seed));
	...
	# fqnm_list = []
	# method_fqn_type_map = {}
	# # In case we match a typed_method_call
	...
	# # Case we match only a method_call 1. determine FQNM 2. assign variable name to FQN
