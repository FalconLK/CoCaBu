...
def main():
	body = """ <p>Use <a href="http://download.oracle.com/javase/6/docs/api/java/util/Collections.html#shuffle%28java.util.List,%20java.util.Random%29"><code>Collections.shuffle()</code></a> twice, with two <code>Random</code> objects initialized with the same seed:</p>  <pre><code>long seed = System.nanoTime(); Collections.shuffle(fileList, new Random(seed)); Collections.shuffle(imgList, new Random(seed)); </code></pre>  """
	body = """<p>Just use the appropriate method: <a href="http://docs.oracle.com/javase/8/docs/api/java/lang/String.html#split-java.lang.String-"><code>String#split()</code></a>.</p>
...
"""
	body = """ <p>This is generally done with a simple user-defined function (i.e. Roll-your-own "isNumeric" function).</p>
